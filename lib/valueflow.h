...
namespace ValueFlow {
    ...
    public:
        ...
        enum ValueType : uint8_t { INT, TOK, FLOAT, MOVED, UNINIT, CONTAINER_SIZE, LIFETIME, BUFFER_SIZE, ITERATOR_START, ITERATOR_END } valueType;
        ...
        enum class LifetimeScope : uint8_t { Local, Argument, SubFunction } lifetimeScope;
