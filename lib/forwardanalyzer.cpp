...
struct ForwardTraversal {
    ...
    ForwardTraversal(const ValuePtr<Analyzer>& analyzer, const Project* project_)
        : analyzer(analyzer), project(project_), actions(Analyzer::Action::None), analyzeOnly(false)
    {}
...
Analyzer::Action valueFlowGenericForward(Token* start,
        ...
        const Project* project)
{
    ForwardTraversal ft{a, project};
    ft.updateRange(start, end);
    return ft.actions;
}

Analyzer::Action valueFlowGenericForward(Token* start, const ValuePtr<Analyzer>& a, const Project* project)
{
    ForwardTraversal ft{a, project};
