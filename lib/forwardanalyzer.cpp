...
struct ForwardTraversal {
    ...
    ForwardTraversal(const ValuePtr<ForwardAnalyzer>& analyzer, const Project* project_)
        : analyzer(analyzer), project(project_), actions(ForwardAnalyzer::Action::None), analyzeOnly(false)
    {}
