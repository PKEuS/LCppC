...
void Check64BitPortability::assignmentAddressToIntegerError(const Token *tok)
{
    reportError(tok, Severity::portability,
                ...
                "way is to store addresses only in pointer types (or typedefs like uintptr_t).", CWE758, Certainty::safe);
}
...
void Check64BitPortability::returnPointerError(const Token *tok)
{
    reportError(tok, Severity::portability,
                ...
                "to 32-bit integer. The safe way is to always return an integer.", CWE758, Certainty::safe);
}
...
void Check64BitPortability::returnIntegerError(const Token *tok)
{
    reportError(tok, Severity::portability,
                ...
                "The safe way is to always return a pointer.", CWE758, Certainty::safe);
}
